...
public class CalculatorController {
    ...
    ResponseEntity<Double> responseAdd = new ResponseEntity<>(result, HttpStatus.ACCEPTED);
    return responseAdd;
    ...
    public ResponseEntity<Double> subtract(@PathVariable("numA") Double num1, @PathVariable("numB") Double num2){
        ...
        ResponseEntity<Double> responseSubtract = new ResponseEntity<>(result,HttpStatus.OK);
        return responseSubtract;
    }
    ...
    public ResponseEntity<Double>  multiply(@RequestBody CalculatorDTO calculatorDTO){
        ...
        ResponseEntity<Double> responseMultiply = new ResponseEntity<>(result, HttpStatus.CREATED);
        return responseMultiply;
    }
